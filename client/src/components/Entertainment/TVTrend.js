...
const TVJson = [
  ...
  { title: "법쩐", cast: "SBS", rate: "9.1%", url: "?where=nexearch&sm=tab_etc&pkid=57&os=29549460&qvt=0&query=%EB%B2%95%EC%A9%90" },
  { title: "KBS 뉴스 9", cast: "KBS1", rate: "8.7%", url: "?where=nexearch&sm=tab_etc&pkid=57&os=658738&qvt=0&query=KBS%20%EB%89%B4%EC%8A%A4%209" },
  {
    title: "불후의 명곡",
    cast: "KBS2",
    rate: "8.1%",
